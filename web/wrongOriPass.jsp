...
<div class="text">
    您输入的原始密码不正确，请重新输入<br/><span class="english">The original password you entered is incorrect, please re-enter.
</span>
</div>
<a href="oriPass.jsp" style="text-decoration: none"><button class="return" >返&nbsp;&nbsp;&nbsp;&nbsp;回 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;</button></a>
