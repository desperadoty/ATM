...
<div class="text">
    请再次输入您的新密码并以确认键结束<br/><span class="english">Please re-enter your new password and press the enter key to the end.</span>
</div>
<%
    String newPass = request.getParameter("newPass");
    request.getSession().setAttribute("newPass",newPass);
    if(newPass.length()!= 6) {
        response.sendRedirect("newPass_fail.jsp");
    }
%>

<form action="servlet/PasswordServlet" method="post">
    <input class="pass" id="pass" type="password"  name="newPsw" >
