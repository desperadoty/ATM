...
<div class="text">
    请输入您的原始密码并以确定键结束<br/><span class="english">Please enter your original password and press the enter key to the end.</span>
</div>
<form action="servlet/LoginServlet" method="post">
    <input class="pass" id="pass" type="password" name="oriPass" >
    ...
    <input class="return" type="button" value="返&nbsp;&nbsp;&nbsp;&nbsp;回 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;"/>

    <input class="exit" type="button" value=" &lt;&minus;&nbsp;&nbsp;&nbsp;&nbsp;退&nbsp;&nbsp;&nbsp;&nbsp;卡" />
</form>
