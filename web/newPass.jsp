...
<div class="text">
    请输入您的新密码并以确定键结束<br/><span class="english">Please enter your new password and press the enter key to the end.</span>
</div>
<form action="reNewPass.jsp">
    <input class="pass" id="pass" type="password"  name="newPass" />
    <div class="grid_wrapper" method="post">
        <ul class="grid">
