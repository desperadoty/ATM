...
<div class="text">
    密码错误，请重新输入<br/><span class="english">Password error, please re-enter.</span>
</div>
<form action="servlet/LoginServlet" method="post">
    <input class="pass" id="pass" type="password"  name="password" >
...
<div id="time"></div>
<a href="check_ok.jsp" style="text-decoration: none"><button class="return" >返&nbsp;&nbsp;&nbsp;&nbsp;回 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;</button></a>
