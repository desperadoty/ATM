...
<div class="text">
    ...
    <p>
        ...
        <span class="english">Transaction amount:RMB&nbsp;<%=deposit%></span><br/>
    </p>
</div>
<form method="post" action="servlet/ServiceServlet">
    <input class="show" type="button" name="inquireAfterDeposit" value="显&nbsp;示&nbsp;余&nbsp;额 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;"
           onclick="document.getElementById('btnType').value=this.name;this.form.submit()"/>
    <input type="hidden" id="btnType" name="btnType"/>
</form>

<a href="<%=path%>/deposit.jsp" style="text-decoration: none">
    <button class="continuecash">
        &lt;&minus;&nbsp;&nbsp;&nbsp;&nbsp;继 &nbsp;续&nbsp;存&nbsp;款
    </button>
</a>
