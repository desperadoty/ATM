...
<body>
<%
    String deposit = request.getSession().getAttribute("deposit").toString();
%>
...
<div class="text">
    您的账户将存入&nbsp;<%=deposit%>&nbsp;元<br/><span class="english">Your account will deposit RMB&nbsp;<%=deposit%></span>
</div>
<div id="time"></div>
<a href="deposit.jsp" style="text-decoration: none"><button class="return">&lt;&minus;&nbsp;&nbsp;&nbsp;&nbsp;返&nbsp;&nbsp;&nbsp;&nbsp;回</button></a>
<a href="deposit_ok.jsp" style="text-decoration: none"><button class="submit">确&nbsp;&nbsp;&nbsp;&nbsp;认 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;</button></a>
</body>
</html>
