...
<head>
    ...
    <script language="javascript" type="text/javascript">
        function btnRes_onclick() {
            str = document.getElementById("money");
            num=str.value;
...
<div class="text">
    请您选择或输入转账金额<br/><span class="english">Please select or input amount</span>
</div>

<form action="servlet/TransferServlet" method="post">
    <input class="money" type="text" id="money" name="money" >
