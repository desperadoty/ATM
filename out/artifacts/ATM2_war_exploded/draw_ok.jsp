...
<%
    ...
    String draw = request.getSession().getAttribute("draw").toString();
%>
...
<div class="text">
    ...
    <p>
        ...
        <span class="english">Transaction amount:RMB&nbsp;<%=draw%></span><br/>
    </p>
</div>
<form method="post" action="servlet/ServiceServlet">
    <input class="show" type="button" name="inquireAfterDraw" value="显&nbsp;示&nbsp;余&nbsp;额 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;"
           onclick="document.getElementById('btnType').value=this.name;this.form.submit()"/>
    <input type="hidden" id="btnType" name="btnType"/>
</form>

<a href="<%=path%>/draw.jsp" style="text-decoration: none">
