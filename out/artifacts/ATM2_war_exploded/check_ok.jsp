...
<div class="text">
    请输入您的密码并以确定键结束<br/><span class="english">Please input your bank account and press the enter key to the end.</span>
</div>
<div>
    <form action="servlet/LoginServlet" method="post">
        <input class="password" id="pass" type="password" name="password" value=""/>
...
<div id="time"></div>
<a href="index.jsp" style="text-decoration: none"><button class="return" >返&nbsp;&nbsp;&nbsp;&nbsp;回 &nbsp;&nbsp;&nbsp;&nbsp;&minus;&gt;</button></a>
